...
## 문서 목적
이 문서는 단계별 학습 목표와 실습 흐름을 시간 순서로 안내하기 위한 시나리오 문서입니다.  
학습자 관점에서 “무엇을 먼저 이해하고 실습할지”를 명확히 전달하는 데 사용합니다.
...
gantt
  ...
  section Phase 1
  로그인/Firestore 이해 :a1, 2026-01-01, 2d
  MQTT 모니터링    :a2, after a1, 2d
  Amplify 배포     :a3, after a2, 1d
  section Phase 2
  Backend 연동      :b1, 2026-01-10, 3d
  SQL 저장/분석      :b2, after b1, 3d
```
