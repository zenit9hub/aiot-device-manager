...
## 문서 목적
이 문서는 배포 절차와 운영 점검 항목을 표준화해, 강의 실습 결과를 안정적으로 재현하기 위한 문서입니다.  
Amplify 배포와 운영 트러블 대응의 기준 문서로 사용합니다.
...
3. Output Directory: `aiot-dvc-mgr-fe-2.0-refactoring/dist`.
4. 환경 변수: `VITE_*` 값 등록.
